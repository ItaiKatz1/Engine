...
public class Indexer extends Thread {
    ...
    public HashMap<String, Integer> readTermsTfFromDisk() throws IOException {
        ...
        File file = new File(path + "/TermsTF.txt");
    ...
    /**
     * The method receives a term and returns a list that holds the matching posting file to the term
     * @param term
     * @return  a linked-list that holds the term's relevant posting file, null if the posting file doesn't exist
     * @throws IOException
     */
